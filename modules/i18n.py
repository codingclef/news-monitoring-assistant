...
KO: dict[str, str] = {
    ...
    "ilam_feedback_hint": "✏️ 분류결과를 수정하려면 각 분류 탭(보류, 해당없음 포함)에서 분류결과를 변경한 뒤 피드백 저장을 눌러주세요.",
...
JA: dict[str, str] = {
    ...
    "ilam_feedback_hint": "✏️ 分類結果を修正するには、各分類タブ（保留・該当なし含む）で分類結果を変更後「フィードバック保存」を押してください。",
